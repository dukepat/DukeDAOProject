...
export default function Home() {
    ...
    if (loading) {
      ...
      return (
        <div className={styles.container}>
          <label>Demo NFT Token ID to Purchase: </label>
          <input
            placeholder="0"
            type="number"
  ...
  return (
    <div>
      <Head>
        <title>Duke CryptoDevs DAO</title>
      ...
      <div className={styles.main}>
        <div>
          <h1 className={styles.title}>Welcome to Duke Crypto Devs!</h1>
          <div className={styles.description}>Welcome to the Decentralised Autonomous Organisation- DAO!</div>
          <div className={styles.description}>
